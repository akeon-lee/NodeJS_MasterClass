// This module is for the request handlers
    ...
    _data.read('users', phone, (err, data) => {
      if(err) {
        ...
        if(hashedPassword) {
          ...
          callback(500, { 'Error': 'Could not hash the users passowrd' });
    ...
    _data.read('tokens', id, (err, tokenData) => {
      if(!err && tokenData) {
        ...
        if(tokenData.expires > Date.now()) {
          ...
          callback(400, { 'Erorr': 'The token has already expired and cannot be extened' });
        }
      } else {
